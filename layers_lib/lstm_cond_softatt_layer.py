...
def param_init(options, params,
                         prefix='lstm_softatt', nin=None, dim=None, dimctx=None):
    if nin == None:
        nin = options['dim']
    if dim == None:
        dim = options['dim']
...
def get_layer(options, tparams, state_below, 
                    mask=None, context=None, one_step=False, ctx_mean=None,
                    init_memory=None, init_state=None,
                    trng=None, use_noise=None,mode=None,
                    prefix='lstm_softatt',**kwargs):
    ...
    # projected x
    state_below = T.dot(state_below, tparams[_p(prefix, 'W')]) + tparams[_p(prefix, 'b')] + \
                  T.dot(ctx_mean, tparams[_p(prefix,'V')])
